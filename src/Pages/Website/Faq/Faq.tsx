        ...
        <div className="space-y-6">
          {faqs.map((faq, i) => (
            <motion.div
              ...
              className="bg-card text-card-foreground p-6 rounded-2xl shadow-md hover:shadow-lg hover:scale-[1.02] border-l-4 border-primary transition-transform duration-300"
            >
